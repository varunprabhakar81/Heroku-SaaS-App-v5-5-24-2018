...
module.exports = function(app, passport){
	...
	passport.use(new FacebookStrategy({
		...
		callbackURL: "https://powerful-gorge-14292.herokuapp.com/auth/facebook/callback",
	...
	passport.use(new TwitterStrategy({
		...
		callbackURL: "http://powerful-gorge-14292.herokuapp.com/auth/twitter/callback",
	...
	passport.use(new GoogleStrategy({
	    ...
	    callbackURL: "http://powerful-gorge-14292.herokuapp.com/auth/google/callback"
	  },
	  function(token, tokenSecret, profile, done) {
		//console.log(profile.emails[0].value);
		// console.log(profile._json.email);
