			...
			user.save(function(err){
				if (err) {
					...
					var email = {
					  ...
					  text: 'Hello' + user.name +'Thank you for registering at DigitalCloud ERP. Please click on the following link to complete your activation: http://powerful-gorge-14292.herokuapp.com/activate/' + user.temporarytoken,
					  html: 'Hello<strong> ' + user.name +'</strong>, <br><br> Thank you for registering at DigitalCloud ERP. Please click on the link below to complete your activation:<br><br> <a href="http://powerful-gorge-14292.herokuapp.com/activate/' + user.temporarytoken + '">http://powerful-gorge-14292.herokuapp.com/activate</a>'
					};
			...
			user.save(function(err) {
				if(err) { 
					...
					var email = {
					  ...
					  text: 'Hello' + user.name +'You recently requested new account activation link. Please click on the following link to complete your activation: http://powerful-gorge-14292.herokuapp.com/activate/' + user.temporarytoken,
					  html: 'Hello<strong> ' + user.name +'</strong>, <br><br> You recently requested new account activation link. Please click on the link below to complete your activation:<br><br> <a href="http://powerful-gorge-14292.herokuapp.com/activate/' + user.temporarytoken + '">http://powerful-gorge-14292.herokuapp.com/activate</a>'
					};
				...
				user.save(function(err) {
					if (err) {
						...
						var email = {
							...
							text: 'Hello ' + user.name + ', You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="http://powerful-gorge-14292.herokuapp.com/reset/' + user.resettoken,
							html: 'Hello<strong> ' + user.name + '</strong>,<br><br>You recently request a password reset link. Please click on the link below to reset your password:<br><br><a href="http://powerful-gorge-14292.herokuapp.com/reset/' + user.resettoken + '">http://powerful-gorge-14292.herokuapp.com/reset/</a>'
						};
